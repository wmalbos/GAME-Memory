...
// On récupère les meilleurs entrées des statistiques
$players = Statistic::getTopStatistics($database);
...
<div id="game" class="memory-game">
        ...
        <div class="menu-container">
            ...
            <div class="menu-controls">
                ...
                <button class="btn btn-ranking">
                    ...
                    <span>Classement des joueurs</span></button>
            ...
            <div class="menu-content">
                ...
                <form action="action.php" method="post" class="form form-rank">
                    <div class="form-group">
                        <label for="rank_player_name" class="new-label">Votre nom :</label>
                        <input type="text" name="rank_player_name" id="rank_player_name" class="rank-input">
                        <input type="hidden" name="rank_player_score" id="rank_player_score" value="100">
                    </div>
                    <div class="form-controls">
                        <input type="submit" id="rank_player_submit" value="Sauvegarder" class="rank-submit">
                    </div>
                </form>
            </div>
    ...
    <div id="board" class="board">
        ...
        <div class="board-content">
            <!-- Affichage de la liste des cartes du jeu -->
            <ul id="cards_list" class="cards-list"></ul>
        </div>
            ...
            <div class="board-stats">
                <div class="column">
                    <div class="block block-games">
                        <p class="block-label">Nombre de parties :
                            <span id="game_counter" class="block-value">0</span>
                        </p>
                    </div>
                    <div class="block block-counter">
                        <p class="block-label">Nombre de coups :
                            <span id="shots_counter" class="block-value">3</span>
                        </p>
                    </div>
                    <div class="block block-level">
                        <p class="block-label">Difficulté :
                ...
                <div class="column">
                    <div class="block block-time">
                        <p class="block-label">Temps restant :
                            <span class="block-value">
                                <span id="timer_min">0</span> min et <span id="timer_sec">0</span> sec
                            </span>
                        </p>
